...
export interface SunPlaceholderIconProps extends SVGProps<SVGSVGElement> {
  size?: number;
}

function SunPlaceholderIcon({ size = 18, ...props }: SunPlaceholderIconProps) {
  return (
    <svg
