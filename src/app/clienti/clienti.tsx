      ...
      <div className="relative flex w-full flex-col gap-4.5">
        ...
        <div className="page-header-gradient flex items-center justify-between gap-2.5">
          ...
          <div className="flex items-center justify-center gap-2.5">
            <button className="flex cursor-pointer items-center justify-center gap-2.5 rounded-full border border-white/30 bg-white/20 py-1.75 pr-2.5 pl-3.75 text-sm text-white transition-colors hover:bg-white/30">
              Aggiungi
